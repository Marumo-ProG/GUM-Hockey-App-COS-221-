...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="tournament-Info.html">Tournaments & Upcoming Matches</a>
        </li>
        <li class="nav-item">
 ...
 <footer class="bg-light text-center text-lg-start">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Tournaments & Upcoming Matches</li>
  </ol>
