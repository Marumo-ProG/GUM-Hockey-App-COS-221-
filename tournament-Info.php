  ...
  <div class="table-container">
    <table class="Tournaments" id="Tournaments">
      ...
      while ($c < count($playerStats)) {
        $row = $playerStats[$c];
        echo '<tr><td>' . $row["Tournament_Name"] . '</td>
            <td>' . $row["Tournament_Season"] . '</td>
            <td>' . $row["Tournament_Location_City"] . '</td>
            <td>' . $row["Tournament_Location_Country"] . '</td>
            <td>' . $row["Tournament_Winner"] . '</td>
            </tr>';
        $c++;
      }
      ?>
