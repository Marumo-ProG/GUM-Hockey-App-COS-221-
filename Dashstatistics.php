    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
     ...
     <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">InDepth Statistics</h1>
      ...
      <h2>Offensive Player Stats</h2>
      <div class="table-responsive">
        <table class="table table-striped table-sm" id="playerTable">
          <thead>
            <tr>
              ...
              <th scope="col">Total Games Starting</th>
              <th scope="col">Shot accuracy</th>
              <th scope="col">Total Assits</th>
            </tr>
          </thead>
          <tbody>
            <tr>
...
<hr>
       <h2>Defensive Player Stats</h2>
      <div class="table-responsive">
        <table class="table table-striped table-sm" id="playerDefTable">
          <thead>
            <tr>
              <th scope="col">Ranking</th>
               <th scope="col">Player Name</th>
              ...
              <th scope="col">Cards Obtained</th>
              <th scope="col">Total Games Starting</th>
              <th scope="col">Total Shots Blocked</th>
              <th scope="col">Clean Sheets(GK)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
      ...
      <hr>
       <h2>Coach Stats</h2>
      <div class="table-responsive">
        <table class="table table-striped table-sm" id="coachTable">
          <thead>
            <tr>
              <th scope="col">Ranking</th>
              ...
              <th scope="col">Total Tournaments Won</th>
      ...
      <hr>
       <h2>Team Stats</h2>
      <div class="table-responsive">
        <table class="table table-striped table-sm" id="teamTable">
          <thead>
            <tr>
              <th scope="col">Ranking</th>
